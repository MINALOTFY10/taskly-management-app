import { GitBranch, LayoutGrid, Plus, Rocket, Ruler, Sparkles, TrendingUp } from "lucide-react"
...
export default function EpicsEmpty() {
  return (
    <section className="flex flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <h2 className="text-2xl font-bold text-foreground">No epics in this project yet.</h2>
      ...
      <Button className="mt-8 h-12 gap-2 px-8 text-sm font-semibold shadow-[0_8px_20px_rgba(0,50,184,0.18)]" size="lg">
      ...
      <div className="mt-12 grid w-full max-w-2xl grid-cols-1 gap-4 sm:grid-cols-3">
        {featureCards.map((card) => (
          <div key={card.title} className="rounded-xl border border-border/60 bg-card px-5 py-4 text-left shadow-sm">
